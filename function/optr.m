...
term1 = 1/2 * norm(Data.M.*(HingeL.^2),1);
term1R = Data.lambda1 * 1/2 * norm(Data.J.*Data.M.*(Data.Ytrain * Rplus - Data.Ytrain),'fro')^2;
Sabs=0;
for i=1:m
...
term4 =  Data.lambda2 * trace((Data.Xtrain*Data.W)*L*(Data.Xtrain*Data.W)');
f = term1+term1R+term2-term3+term4;
gterm1=Data.Ytrain' * (HingeL .* (-(Data.Xtrain * Data.W) .* Data.M));
gterm1R = Data.lambda1 * Data.Ytrain' * ((Data.Ytrain * Rplus - Data.Ytrain) .* Data.J.*Data.M);
g=gterm1+gterm1R;
g=reshape(g, m*m, 1);
end